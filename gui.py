...
def main_window_function():
    ...
    matrizJavier_button = Button(main_window, text="MatrizAD. Javier",command= openNewWindowJaviMAD,  width =16, bg='#1E5692', fg='#ffffff', font=font.Font(size=16, weight='bold')) 
